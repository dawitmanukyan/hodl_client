...
const Nfts = () => {
    ...
    const api_url = 'http://127.0.0.1:8000/api/most_nfts';

    const api = 'http://127.0.0.1:8000/api/like/nft';

    const apiunlike = 'http://127.0.0.1:8000/api/unlike/nft';
