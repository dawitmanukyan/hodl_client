...
const AddNft = () => {
    ...
    const api = 'http://127.0.0.1:8000/api/nft/create';
  ...
  return (
    ...
    <div id={classes.addbtnsdiv}>
        <div id={classes.addbtns}>
                ...
                <Link to={'/add-nft'}>
                    <button className={classes.add_btn} style={{background: '#31A8DC'}}>Add NFT</button>
                </Link>
        </div>
    </div>
    <div id={classes.addcoin_form_div}>
            ...
            {success ? <Success data={'NFT successfully added !'}/> : ''}
            <form id={classes.addcoin_form} onSubmit={handleSubmit(onSubmit)}>
                <div className={classes.form_div}>
                    ...
                    <div>
                        <div className={classes.inptinform}>
                            <p className={classes.inptinfo}>Link to Nft</p>
                            <p className={classes.required}>Required</p>
                        </div>
                ...
                <div className={classes.form_div}>
                    ...
                    <div>
                        <div className={classes.inptinform}>
                            <p className={classes.inptinfo}>Price</p>
                        </div>
            ...
            <div className={classes.add_div}>
                <button id={classes.addcoinbutton}>Add NFT</button>
            </div>
            </form>
        </div>
        <Footer />
